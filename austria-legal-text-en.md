...
6. after 90 minutes of uninterrupted play by a participant, the gaming machine switches off (**cooling-off phase**).
The player's cool-down period must last at least 15 minutes. During the cooling-off phase, the player must be shown a video explaining the risks associated with gambling."
...
Bingo and Keno are draws in which an organiser accepts and executes bets on the odds of winning number combinations, whereby winnings are achieved by the players by matching the corresponding number combinations with the determined winning numbers.
